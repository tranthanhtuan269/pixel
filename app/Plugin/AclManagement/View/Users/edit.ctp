...
$employee['User']['status'] = $employee['User']['status']?"1":"0";
 ?>
<div id="breadcrumbs">
    <ul class="breadcrumb">
        <li>
        ...
        <li class="active">
            <?php echo __('Sửa chi tiết người dùng'); ?>
        </li>
    </ul>
</div>
<!-- BEGIN Main Content -->
...
<div class="box">
<div class="box-title">
    <h3><i class="icon-reorder"></i><?php echo __('Sửa thông tin người dùng'); ?></h3>
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append date date-picker">
                            <?php echo $this->Form->input('date_of_birth', array('placeholder' => '', 'type' => 'text', 'class' => 'datepicker', 'label' => false, 'div' => false)) ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio inline">
                            <input type="radio" <?php if($employee['User']['gender'] == 0){echo('checked=""');}?>value="0" name="data[User][gender]"> <?php echo __('Nữ'); ?>
                        </label>
                        <label class="radio inline">
                            <input type="radio" <?php if($employee['User']['gender'] == 1){echo('checked=""');}?> value="1"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="span12">
                            <?php echo $this->Form->input('basic_salary', array('type' => 'text','placeholder' => '', 'class' => 'input-xlarge', 'label' => false)) ?>
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="span6">
                    <div class="control-group">
                        ...
                        <div class="username_user">
                            <?php echo $employee['User']['username']; ?>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div data-provides="fileupload" class="fileupload fileupload-new">
                            <div style="width: 200px; height: 150px;" class="fileupload-new thumbnail">
                                ...
                                src="<?php if ($employee ['User']['avatar'] != '') {
                                    echo $domain . 'medias/avatar_employee/' . $employee ['User']['avatar'];
                                } else {
                            ...
                            <div>
                                               ...
                                               <input type="file" class="default"
                                                      value="<?php echo $employee ['User']['avatar']; ?>"
...
<script>
    var treeData = [
        <?php
        $hidden = explode(',',$employee['User']['customer_group_id']);
//        echo $hidden;die;
        foreach ($countries as $country){
        ?>
        {title: "<?php echo $country['Country']['name']?>", folder: true,key: "country_<?php echo $country['Country']['id']?>",<?php if(in_array('country_'.$country['Country']['id'],$hidden)){echo('selected: true,');}?>
            children: [
                <?php
                    foreach($country['children'] as $customer){
                ?>

                {title: "<?php echo $customer['Customer']['name']?>", key: "cus_<?php echo $customer['Customer']['id']?>",<?php if(in_array('cus_'.$customer['Customer']['id'],$hidden)){echo('selected: true,');}?>
                    children: [
                        <?php
                            foreach($customer['children'] as $cus_gr){
                        ?>
                        {title: "<?php echo $cus_gr['CustomerGroup']['name']?>", key: "cusgr_<?php echo $cus_gr['CustomerGroup']['id']?>",<?php if(in_array('cusgr_'.$cus_gr['CustomerGroup']['id'],$hidden)){echo('selected: true,');}?> },
                        <?php
                            }
                        ?>
                    ]
