...
//    $("html").niceScroll({zindex: 999});
    ...
    $("#sidebar-collapse").click(function () {
        ...
        if ($("#sidebar").hasClass("sidebar-collapsed")) {
            ...
            $.cookie('sidebar-collapsed', 'flase');
        }
    ...
    $("#theme-setting ul.colors a").click(function () {
        ...
        $.cookie(r + 'color', i);
        if(r == 'skin-'){
            $.cookie('sidebar-color',i);
            $.cookie('navbar-color',i);
        }
    ...
    if (jQuery().dataTable) {
        $("#table1").dataTable({aLengthMenu: [
            [10, 15, 25, 50, 100, -1],
            [10, 15, 25, 50, 100, "All"]
        ], iDisplayLength: 10, oLanguage: {sLengthMenu: "_MENU_ Records per page", sInfo: "_START_ - _END_ of _TOTAL_", sInfoEmpty: "0 - 0 of 0", oPaginate: {sPrevious: "Prev", sNext: "Next"}}, aoColumnDefs: [
    ...
    if (jQuery().plot) {
        ...
        function i() {
            ...
            $.plot($("#chart_1"), [
                ...
                {label: "cos(x)", data: n},
                {label: "tan(x)", data: r}
            ], {series: {lines: {show: true}, points: {show: true}}, xaxis: {ticks: [0, [Math.PI / 2, "?/2"], [Math.PI, "?"], [Math.PI * 3 / 2, "3?/2"], [Math.PI * 2, "2?"]]}, yaxis: {ticks: 10, min: -2, max: 2}, grid: {backgroundColor: {colors: ["#fff", "#eee"]}}})
        }
