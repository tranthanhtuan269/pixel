...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active">
            <?php echo __('Sửa thông tin quốc gia'); ?>
        </li>
    </ul>
</div>
<!-- BEGIN Main Content -->
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-reorder"></i><?php echo __('Sửa thông tin quốc gia'); ?></h3>
                            ...
                            <div class="controls">
                                <div data-provides="fileupload" class="fileupload fileupload-new">
                                    <div style="width: 200px;" class="fileupload-new thumbnail">
                                        <img style="width: 200px;alt="" src="<?php if($this->request->data['Country']['flag']!=''){echo '/medias/countries/'.$this->request->data['Country']['flag'];}else{echo 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image';}?>">
                                    </div>
