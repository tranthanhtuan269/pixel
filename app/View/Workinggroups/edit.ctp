...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-reorder"></i><?php echo __('Sửa nhóm'); ?></h3>
                <div class="box-tool">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="span12">
                            ...
                            <?php echo $this->Form->input('id', array('placeholder' => '', 'class' => 'input-xlarge', 'label' => false)) ?>
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="span8">
                            <textarea name="NV_ten_1" id="NV_ten_1" readonly="true" class="span12" rows="2" ><?php echo isset($usernames1) ? $usernames1 : '' ?></textarea>
                            <input type="hidden" value="<?php echo $this->request->data['WorkingGroup']['user_ids'] ?>" name="NV_ID_1" id="NV_ID_1"/>
                        </div>
                        <div class="span12">
