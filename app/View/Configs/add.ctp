...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active">
            <?php echo __('Thêm thông tin cấu hình'); ?>
        </li>
    </ul>
</div>
<!-- BEGIN Main Content -->
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-reorder"></i><?php echo __('Thêm mới thông tin cấu hình'); ?></h3>
                <div class="box-tool">
            ...
            <div class="box-content">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="span12">
                            <?php echo $this->Form->input('code', array('placeholder' => '', 'class' => 'input-xlarge', 'label' => false, 'data-rule-required' => 'true', 'data-rule-minlength' => '3')) ?>
                        </div>
                    </div>
                </div>
                <div class="control-group">
