...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-reorder"></i><?php echo __('Thêm mới loại xử lý'); ?></h3>
                <div class="box-tool">
            ...
            <div class="box-content">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $this->Form->input('number', array('type' => 'text', 'div' => false, 'label' => false,'value' => 1)); ?>
                    </div>
                </div>
                <div class="control-group">
