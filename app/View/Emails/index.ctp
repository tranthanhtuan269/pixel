...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="<?php echo Router::url(array('action' => 'index')); ?>"><b><?php echo __('Quản lý Template Email'); ?></b></a>
        </li>
    </ul>
</div>
        ...
        <div class="box">
            <div class="box-content">
                    ...
                    <div class="btn-group">
                        <div class="box-content">
                            <a style="margin-right: 5px" class="btn btn-small btn-primary show-tooltip" title="Thêm mới"
                               href="<?php echo Router::url(array('controller' => 'emails', 'action' => 'add')); ?>">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        <?php echo $this->Form->create('Email', array('type' => 'get'));
                        ?>
            ...
            <table class="table table-advance" id="table1">
                ...
                <tr>
                    ...
                    <th class="text-center"><?php echo __('Thông số'); ?></th>
                ...
                foreach ($emails as $item):
                    ?>
                    <tr class="table-flag">
                        <td><input value="<?php echo $item['Email']['id']; ?>" type="checkbox" name="ck[]"/></td>
                        <td><?php echo $this->Html->link($item['Email']['title'], array('action' => 'edit', $item['Email']['id'])); ?></td>
                        <td class="text-center"><?php echo $item['Email']['note'] ?></td>
                        <td class="text-center"
                            id="ajax<?php echo $item['Email']['id'] ?>"><a class="btn btn-circle show-tooltip"
                                                                           onclick="status(<?php echo $item['Email']['id'] . ',' . $item['Email']['status']; ?>)"><?php if ($item['Email']['status'] == 1) {
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-small show-tooltip" title="Sửa"
                                   href="<?php echo Router::url(array('controller' => 'emails', 'action' => 'edit')); ?>/<?php echo $item['Email']['id']; ?>"><i
                                        class="icon-edit"></i></a>
...
<script>
    function status(id, status) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'emails','action' => 'status')); ?>/" + id + "/" + status,
    ...
    function Pagination() {
        location.href = "/emails/index/" + $('#pagination').val();
    }
