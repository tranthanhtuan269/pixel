...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active">
            <?php echo __('Sửa Template Email'); ?>
        </li>
    </ul>
</div>
<!-- BEGIN Main Content -->
        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="span12">
                            <?php echo $this->Form->input('note', array('placeholder' => '', 'type'=>'textarea', 'class' => 'input-xxlarge', 'label' => false, 'data-rule-required' => 'false', 'data-rule-minlength' => '3', 'readonly'=>'false')) ?>
                        </div>
                    </div>
                </div>
