                ...
                <div class="row-fluid">
                    <div class="span6">
                        <div class="control-group">
                            <?php echo $this->Form->input('user_id', array('placeholder' => '', 'type' => 'hidden', 'class' => 'input-xlarge', 'label' => false)) ?>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="span12">
                                    <?php echo $this->Form->input('from_date', array('placeholder' => '', 'type' => 'text', 'class' => 'input-small', 'label' => false, 'div' => false, 'data-rule-required' => 'true')) ?>
                                    Đến ngày :
                    ...
                    <div class="span6">
                        ...
                        <div class="control-group">
                            <label class="control-label red"><?php echo __('Trạng thái phê duyệt'); ?></label>
