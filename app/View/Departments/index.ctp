...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="<?php echo Router::url(array('action' => 'index')); ?>"><b><?php echo __('Quản lý phòng ban'); ?></b></a>
        </li>
    </ul>
</div>
        ...
        <div class="box">
            <div class="box-content">
                    ...
                    <div class="btn-group">
                        <div class="box-content">
                            <a style="margin-right: 5px" class="btn btn-small btn-primary show-tooltip" title="Thêm mới"
                               href="<?php echo Router::url(array('controller'=>'departments','action' => 'add')); ?>">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span6">
                        <?php echo $this->Form->create('Department', array('type' => 'get'));
                        ?>
            ...
            <table class="table table-advance" id="table1">
                ...
                <tr>
                    ...
                    <th><?php echo __('Tên phòng ban'); ?></th>
                ...
                foreach ($department as $item):
                    ?>
                    <tr class="table-flag">
                        <td><input value="<?php echo $item['Department']['id']; ?>" type="checkbox" name="ck[]"/></td>
                        <td><?php echo $this->Html->link($item['Department']['name'], array('action' => 'edit', $item['Department']['id'])); ?></td>
                        <td><?php echo $item['Department']['address'] ?></td>
                        <td class="text-center"><?php echo $item['Department']['order'] ?></td>
                        <td class="text-center"
                            id="ajax<?php echo $item['Department']['id'] ?>"><a  class="btn btn-circle show-tooltip"
                                onclick="status(<?php echo $item['Department']['id']; ?>,<?php echo $item['Department']['status']; ?>)"><?php if ($item['Department']['status'] == 1) {
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-small show-tooltip" title="Sửa"
                                   href="<?php echo Router::url(array('controller'=>'departments','action' => 'edit')); ?>/<?php echo $item['Department']['id']; ?>"><i
                                        class="icon-edit"></i></a>
                                <?php
...
<script>
    function status(id, status) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo Router::url(array('controller'=>'departments','action' => 'status')); ?>/" + id + "/" + status,
    ...
    function Pagination() {
        location.href = "/departments/index/" + $('#pagination').val();
    }
