...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="<?php echo Router::url(array('action' => 'index')); ?>"><?php echo __('Quản lý nhóm Reject'); ?></a>
            <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        <li class="active">
            <?php echo __('Sửa nhóm Reject'); ?>
        </li>
    </ul>
</div>
<!-- BEGIN Main Content -->
    ...
    <div class="span12">
        <div class="box">
            ...
            <div class="box-content">
                <?php echo $this->Form->create('RejectGroup', array('class' => 'form-horizontal validation-form')); ?>
