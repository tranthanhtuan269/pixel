                    ...
                    <td height="25" class="Text_12_black" style="border-top: #CCCCCC 1px dotted;">
                        <?php if ($countNV > 0) { ?>
                            <a onclick="togg1(<?php echo $department['Group']['id'] ?>)">
                                <?php echo $this->html->image($this->webroot.'img/add-1.png',array('id'=>"treePB1{$department['Group']['id']}",'width'=>"16", 'height'=>"16",'border'=>"0"))?>
                            </a>
                        <?php } else {?>
                            <a>
                                <?php echo $this->html->image($this->webroot.'img/sub.png',array('id'=>"treePB1{$department['Group']['id']}",'width'=>"16", 'height'=>"16",'border'=>"0"))?>
                            </a>
                        <?php } ?>
                                ...
                                foreach ($dp[$department['Group']['id']] as $user) {
                                    ...
                                    <tr>
                                        <td  style="padding-left: 25px" height="20px"> &nbsp;&nbsp;&nbsp;
                                            <input name="NSID1" height="20" class="cl1_<?php echo $department['Group']['id'] ?>" id="NSID1" title="<?php echo $user['name'] ?>" type="radio" value="<?php echo $user['id'] ?>" />
    ...
    <script type="text/javascript">
        ...
        function togg1(id){
            ...
            if(st == "none"){
                ...
                $('#treePB1' + id).attr('src', '<?php echo $this->webroot;?>img/sub.png' );

            }else{
                $('#listNS1' + id).css('display', 'none');
                $('#treePB1' + id).attr('src', '<?php echo $this->webroot;?>img/add-1.png' );
            }
        }
