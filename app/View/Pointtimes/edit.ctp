...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-reorder"></i><?php echo __('Sửa thang điểm'); ?></h3>
            ...
            <div class="box-content">
                <?php echo $this->Form->create('Pointtime', array('class' => 'form-horizontal validation-form')); ?>
